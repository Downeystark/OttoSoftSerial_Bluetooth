...
#include "SoftwareOttoSerialCommand.h"


// Constructor makes sure some things are set. 
SoftwareOttoSerialCommand::SoftwareOttoSerialCommand(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic) : SoftwareSerial(receivePin, transmitPin, inverse_logic)
{
...
// 添加软串口模型
// SoftwareOttoSerialCommand::addSoftSerial(SoftwareSerial *bluetooth)
// {
// 	Bluetooth=*bluetooth;
// }
...
//
void SoftwareOttoSerialCommand::clearBuffer()
{
...
char *SoftwareOttoSerialCommand::next() 
{
	char *nextToken;
...
void SoftwareOttoSerialCommand::readSerial() 
{
...
void SoftwareOttoSerialCommand::addCommand(const char *command, void (*function)())
{
...
void SoftwareOttoSerialCommand::addDefaultHandler(void (*function)())
{
