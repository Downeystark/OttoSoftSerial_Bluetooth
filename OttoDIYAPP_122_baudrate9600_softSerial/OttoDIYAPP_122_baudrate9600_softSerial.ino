...
SoftwareOttoSerialCommand SCmd(6, 7); //The SerialCommand object
...
//---------------------------------------------------------
//-- Otto has 5 modes:
//--    * MODE = 0: Otto is awaiting 待机模式
//--    * MODE = 1: Dancing mode! 跳舞模式
//--    * MODE = 2: Obstacle detector mode 距离感应模式
//--    * MODE = 3: Noise detector mode 声音探测探测模式
//--    * MODE = 4: OttoPAD or any Teleoperation mode (listening SerialPort). 串口遥控模式
//---------------------------------------------------------
